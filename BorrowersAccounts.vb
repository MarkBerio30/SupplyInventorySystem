Public Class BorrwersAccount
    Dim CMD As New SqlClient.SqlCommand
    Dim DATASET As New DataSet
    Private Sub BorrwersAccount_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        loaddataM()
    End Sub
    Public Sub loaddataM()
        Try
            ...
            CMD.CommandText = "select [REC NO], [User Code], Name, [Cellphone No], [Email Address], Address from BorrowersTable"
    ...
    Private Sub ButtonBackUA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonBackUA.Click
        Me.Close()
        Mainform.Show()

    End Sub

    Private Sub ButtonNewUA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonNewUA.Click
        Try
            ...
            ElseIf Me.ButtonNewUA.Text = "SAVE" Then
                ...
                Else
                    If MessageBox.Show("DO YOU WANT TO SAVE RECORD?", "SYSTEM MESSAGE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        CONN.Open()
                        CMD = CONN.CreateCommand
                        CMD.CommandText = "Insert Into BorrowersTable values(@User_Code, @Name, @Cellphone_No, @Email_Address, @Address)"
    ...
    Private Sub ButtonEditUA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonEditUA.Click
        Try
            ...
            ElseIf Me.ButtonEditUA.Text = "UPDATE" Then
                ...
                Else
                    If MessageBox.Show("DO YOU WANT TO UPDATE RECORD?", "SYSTEM MESSAGE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        CONN.Open()
                        CMD = CONN.CreateCommand
                        CMD.CommandText = "UPDATE BorrowersTable SET [User Code] = @User_Code, Name = @Name, [Cellphone no] = @Cellphone_No, [Email Address] = @Email_Address, Address = @Address WHERE [REC NO] = '" & Me.Label7.Text & "'"

                        CMD.Parameters.Add("@User_Code", SqlDbType.NVarChar, 50)
                        CMD.Parameters.Add("@Name", SqlDbType.NVarChar, 50)
                        CMD.Parameters.Add("@Celphone_No", SqlDbType.NVarChar, 50)
                        CMD.Parameters.Add("@Email_Address", SqlDbType.NVarChar, 50)
                        CMD.Parameters.Add("@Address", SqlDbType.NVarChar, 50)
    ...
    Private Sub ButtonDeleteUA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonDeleteUA.Click
        Try
    ...
    Private Sub ButtonCancelUA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonCancelUA.Click
        buttondefault()
        cleartext()
    End Sub
End Class